...
<div class="panel panel-default" >
	<div>
		<a type="button" class="btn btn-primary btn-md" href="/addIntraResearch">Add Intra Research</a>
	</div>
	<br>
			...
			<table class="table table-striped table-bordered responsive table-hover table-condensed">
				<thead class="small text-left">
					<tr class="medium">
						...
						<th class="text-center">SL Price</th>
				...
				<tbody>
					<c:forEach items="${researchList}" var="todo">
						<tr>
							...
							<td class="text-center"><fmt:formatNumber value="${((todo.targetPrice-todo.buyPrice)*100/todo.buyPrice)< 0 ? -((todo.targetPrice-todo.buyPrice)*100/todo.buyPrice):((todo.targetPrice-todo.buyPrice)*100/todo.buyPrice)}" maxFractionDigits="2" /></td>
